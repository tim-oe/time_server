...
class TestTimeEntryUpdateSerializer:
    ...
    def test_validate_end_before_start(self):
        ...
        data = {
            "end_time": "2024-01-01T10:00:00Z"  # Before start time
        }
    ...
    def test_validate_end_same_as_start(self):
        ...
        data = {
            "end_time": "2024-01-01T10:00:00Z"  # Same as start time
        }
...
class TestSerializerIntegration:
    ...
    def test_serializer_validation_chain(self):
        ...
        update_data = {
            "end_time": "2024-01-01T09:00:00Z"  # Invalid: end before start
        }
    ...
    def test_serializer_field_consistency(self):
        ...
        create_readonly = set(getattr(TimeEntryCreateSerializer.Meta, 'read_only_fields', []))
        update_readonly = set(getattr(TimeEntryUpdateSerializer.Meta, 'read_only_fields', []))

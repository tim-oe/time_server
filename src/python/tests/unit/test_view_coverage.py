...
class TestRenogyViewCoverage(APITestCase):
    ...
    def test_renogy_device_connect_not_found(self):
        ...
        url = reverse("renogy_device_connect", kwargs={"device_address": "00:00:00:00:00:00"})
    ...
    def test_renogy_device_connect_already_connected(self):
        ...
        with patch('apps.renogy_devices.views.device_manager') as mock_manager:
            ...
            connect_url = reverse("renogy_device_connect", kwargs={"device_address": "F8:55:48:17:99:EB"})
    ...
    def test_renogy_device_disconnect_not_found(self):
        ...
        url = reverse("renogy_device_disconnect", kwargs={"device_address": "00:00:00:00:00:00"})
        response = self.client.post(url)
    ...
    def test_renogy_device_disconnect_already_disconnected(self):
        ...
        with patch('apps.renogy_devices.views.device_manager') as mock_manager:
            ...
            disconnect_url = reverse("renogy_device_disconnect", kwargs={"device_address": "F8:55:48:17:99:EB"})
    ...
    def test_renogy_device_data_not_found(self):
        ...
        url = reverse("renogy_device_data", kwargs={"device_address": "00:00:00:00:00:00"})
    ...
    def test_renogy_device_data_exception(self):
        ...
        with patch('apps.renogy_devices.views.device_manager') as mock_manager, \
            ...
            data_url = reverse("renogy_device_data", kwargs={"device_address": "F8:55:48:17:99:EB"})
    ...
    def test_renogy_all_data_with_errors(self):
        ...
        with patch('apps.renogy_devices.views.device_manager') as mock_manager, \
            ...
            mock_device1.read_data.return_value.to_dict.return_value = {"status": "connected"}

            mock_device2 = Mock()
            mock_device2.is_connected = False

            mock_manager.list_devices.return_value = ["F8:55:48:17:99:EB", "F8:55:48:17:99:EC"]
            mock_manager.get_device.side_effect = [mock_device1, mock_device2]
            mock_manager.devices = {"F8:55:48:17:99:EB": mock_device1, "F8:55:48:17:99:EC": mock_device2}
...
class TestDS18B20ViewCoverage(APITestCase):
    ...
    def test_ds18b20_sensor_temperature_not_found(self):
        ...
        url = reverse("ds18b20_sensor_temperature", kwargs={"sensor_id": "28-000000000000"})
        response = self.client.get(url)
    ...
    def test_ds18b20_sensor_remove_success(self):
        ...
        # Then remove it
        remove_url = reverse("ds18b20_sensor_remove", kwargs={"sensor_id": "28-0123456789ab"})
    ...
    def test_ds18b20_sensor_temperature_success(self):
        ...
        with patch('apps.ds18b20_sensors.views.sensor_manager') as mock_manager:
            ...
            temp_url = reverse("ds18b20_sensor_temperature", kwargs={"sensor_id": "28-0123456789ab"})
    ...
    def test_ds18b20_discover_sensors_success(self):
        ...
        with patch('apps.ds18b20_sensors.views.discover_all_ds18b20_sensors') as mock_discover:
            ...
            self.assertEqual(response.status_code, status.HTTP_200_OK)
            self.assertEqual(response.data["sensor_ids"], ["28-0123456789ab", "28-0123456789cd"])
...
class TestHelperFunctionCoverage:
    ...
    def test_disconnect_device_async_not_connected(self):
        ...
        with patch('apps.renogy_devices.views.device_manager') as mock_manager:
            ...
            assert not hasattr(mock_device, 'disconnect') or not mock_device.disconnect.called
